...
Public Class FrmKeyBoard
    ...
    Private Sub BtLeft_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Form1.CtlFocust.Focus()
        TargetTextBox.Focus()
        My.Computer.Keyboard.SendKeys("{LEFT}", True)
    End Sub

    Private Sub BtRight_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Form1.CtlFocust.Focus()
        TargetTextBox.Focus()
